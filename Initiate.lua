...
game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Divine+] Enabled Invisibility!", "All")
...
game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Divine+] Enabled Spectate GUI!", "All")
...
Scripter.Text = "Scripter: DivineEnding"
...
Copy.Text = "Copy DivineEnding's Channel link"
